          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <ol class="breadcrumb">
                ...
                <li><i class="fa fa-users"></i>All Forums</li>
              </ol>
            </div>
          </div>
                    ...
                    <tbody>
                        @if (count($forums)> 0)
                            ...
                            <tr>
                                ...
                                <td>{!!$forum->desc!!}</td>
                                <td><a href="{{route('forum.overview',$forum->id)}}"><i class="fa fa-eye text-success"></i></a></td>
                                <td><a href="{{route('forum.edit',$forum->id)}}"><i class="fa fa-edit text-info"></i></a></td>
                                <td><a href="{{route('forum.destroy',$forum->id)}}" class="text-danger"><i class="fas fa-trash"></i></a></td>
