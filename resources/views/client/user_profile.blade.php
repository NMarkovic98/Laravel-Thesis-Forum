                        ...
                        <div class="card card-primary card-outline">
                            <div class="card-body box-profile">
                                <div class="text-center">
                                    @if ($user->image)
                                        <img src="{{asset('storage/profile/'.$user->image)}}" width="200" height="200"class="rounded-circle"  /> 
                                    @else
                                    ...
                                    <div class="active tab-pane" id="activity">
                                        ...
                                        <div class="post">
                                          <div class="user-block">
                                               @if ($user->image)
                      <div class="image mr-3"> <img src="{{asset('storage/profile/'.$user->image)}}" class="rounded-circle" height="50"width="50" /> </div>
                      @else
