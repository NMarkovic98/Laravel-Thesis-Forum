  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="row">
          ...
          >
            ...
            <tbody>
              ...
              <tr>
                <td>
                  <div>
                    <span class="font-weight-bold">Joined:<br></span>{{$topic->user->created_at->diffForHumans()}}
                  </div>
                  <div>
                    <span class="font-weight-bold">Topics: </span> {{count($topic->user->topics)}}
                  </div>
                </td>
                <td>
                  <p>
          ...
          <tbody>
            <tr class="table-info">
              ...
              <td class="post-col d-lg-flex justify-content-lg-between">
                ...
                @else 
                <div>
                  <a href="{{route('reply.like',$reply->id)}}" class="mr-3"><i class="fa fa-thumbs-up text-success"></i>{{$reply->like}}</a>
                  <a href="{{route('reply.dislike',$reply->id)}}"><i class="fa fa-thumbs-down text-danger"></i>{{$reply->dislike}}</a>
                </div>
                @endif
              </td>
            </tr>
        ...
        @endforeach
          @else
            <h3>No replies to this topic yet</h3>            
          @endif
        </div>
      </div>
    </div>
